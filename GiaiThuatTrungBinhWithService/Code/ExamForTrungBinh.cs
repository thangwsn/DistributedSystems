...
[System.Web.Services.WebServiceBindingAttribute(Name="ExamForTrungBinhPortBinding", Namespace="http://trungbinh.algorithms/")]
public partial class ExamForTrungBinh : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks/>
    public ExamForTrungBinh() {
        this.Url = "http://chtpt-exercise.herokuapp.com:80/ExamForTrungBinh";
    }
    ...
    /// <remarks/>
    public System.IAsyncResult Beginsubmit(string username, string password, int examId, long questionId, string[] calibrateMs, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("submit", new object[] {
                    username,
                    password,
                    examId,
                    questionId,
                    calibrateMs}, callback, asyncState);
    }
    ...
    /// <remarks/>
    public void submitAsync(string username, string password, int examId, long questionId, string[] calibrateMs) {
        this.submitAsync(username, password, examId, questionId, calibrateMs, null);
    }
    
    /// <remarks/>
    public void submitAsync(string username, string password, int examId, long questionId, string[] calibrateMs, object userState) {
        ...
        this.InvokeAsync("submit", new object[] {
                    ...
                    examId,
                    questionId,
                    calibrateMs}, this.submitOperationCompleted, userState);
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BegingetInputData(string username, string password, int examId, long questionId, string[] memberTimes, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("getInputData", new object[] {
                    username,
                    password,
                    examId,
                    questionId,
                    memberTimes}, callback, asyncState);
    }
    ...
    /// <remarks/>
    public void getInputDataAsync(string username, string password, int examId, long questionId, string[] memberTimes) {
        this.getInputDataAsync(username, password, examId, questionId, memberTimes, null);
    }
    
    /// <remarks/>
    public void getInputDataAsync(string username, string password, int examId, long questionId, string[] memberTimes, object userState) {
        ...
        this.InvokeAsync("getInputData", new object[] {
                    ...
                    examId,
                    questionId,
                    memberTimes}, this.getInputDataOperationCompleted, userState);
    }
